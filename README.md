...
* **01-Guanabara-Youtube/**: Scripts de lógica e sintaxe fundamental.
* **02-Macedo-Udemy/**: Aprofundamento em estruturas de dados e práticas profissionais.
* **03-Lista-Prática/**: Central de exercícios para **prática diária** (140 desafios).
